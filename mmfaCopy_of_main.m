...
load ServerEnergy5.mat
% % 
X = Server.data';
Y= Server.t;
%dataname=data.name;
pre_param.trindv=Server.train;
pre_param.teindv=Server.test;
...
burnin=1000;num=10;space=2;

[oput_par]=supFA_multiSVM(X,pre_param,burnin,num,space);
